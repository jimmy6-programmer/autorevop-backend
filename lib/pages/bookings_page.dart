...
class _BookingsPageState extends State<BookingsPage> {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: AwesomeSnackbarContent(
              title: 'Error',
              message: 'Failed to load towing services (${response.statusCode})',
  ...
  Future<void> _submitBooking() async {
    ...
    final bookingData = {
      ...
      'location': _pickupLocationController.text, // Use pickup location as general location
      ...
      if (response.statusCode == 201) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: AwesomeSnackbarContent(
              title: 'Error',
              message: 'Failed to book towing service (Status: ${response.statusCode})',
              contentType: ContentType.failure,
            ),
            behavior: SnackBarBehavior.floating,
            backgroundColor: Colors.transparent,
    ...
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              widget.translations['towingServiceBooking'] ?? 'Book Towing Service',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: widget.translations['pickupLocationPlaceholder'] ?? 'Enter pickup location',
                border: const UnderlineInputBorder(),
                enabledBorder: const UnderlineInputBorder(
                  borderSide: BorderSide(color: CupertinoColors.inactiveGray),
                ),
            ...
            const SizedBox(height: 24),
            Text(
              widget.translations['vehicleBrandModel'] ?? 'Vehicle Brand & Model',
              style: const TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
                color: CupertinoColors.black,
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            _selectedVehicleMake ?? (widget.translations['vehicleMake'] ?? 'Select Make'),
                            style: TextStyle(
                              color: _selectedVehicleMake != null
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            _selectedVehicleModel ?? (widget.translations['vehicleModel'] ?? 'Select Model'),
                            style: TextStyle(
                              color: _selectedVehicleModel != null
                                  ? CupertinoColors.black
                                  : CupertinoColors.inactiveGray,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: widget.translations['carPlatePlaceholder'] ?? 'Enter car plate number',
                border: const UnderlineInputBorder(),
                enabledBorder: const UnderlineInputBorder(
                  borderSide: BorderSide(color: CupertinoColors.inactiveGray),
                ),
            ...
            _isLoadingServices
                ...
                : GestureDetector(
                    onTap: () => _showCupertinoPicker(
                      context,
                      _towingServices.map((service) => service.name).toList(),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            _selectedService?.name ?? (widget.translations['selectServiceType'] ?? 'Select Service Type'),
                            style: TextStyle(
                              color: _selectedService != null
                                  ? CupertinoColors.black
                                  : CupertinoColors.inactiveGray,
